                ...
                <table class="table table-bordered table-striped table-hover mt-5 mb-5">
                    ...
                    <tbody>
                        <?php 
                                ...
                                $result = mysqli_query($connect, "SELECT * FROM `cargo` WHERE ( `sender_city` = 'Dhaka' OR `sender_city` = 'Rajshahi') AND ( `receiver_city` = 'Dhaka' OR `receiver_city` = 'Rajshahi' ) AND `status` = 1 ");
                        ...
                        <?php 
                                ...
                                $result = mysqli_query($connect, "SELECT * FROM `cargo` WHERE ( `sender_city` = 'Dhaka' OR `sender_city` = 'Rangpur') AND ( `receiver_city` = 'Dhaka' OR `receiver_city` = 'Rangpur' ) AND `status` = 1 ");
                        ...
                        <?php 
                                ...
                                $result = mysqli_query($connect, "SELECT * FROM `cargo` WHERE ( `sender_city` = 'Dhaka' OR `sender_city` = 'Mymensingh') AND ( `receiver_city` = 'Dhaka' OR `receiver_city` = 'Mymensingh' ) AND `status` = 1 ");
                        ...
                        <?php 
                                ...
                                $result = mysqli_query($connect, "SELECT * FROM `cargo` WHERE ( `sender_city` = 'Dhaka' OR `sender_city` = 'Chattogram') AND ( `receiver_city` = 'Dhaka' OR `receiver_city` = 'Chattogram' ) AND `status` = 1 ");
                        ...
                        <?php 
                                ...
                                $result = mysqli_query($connect, "SELECT * FROM `cargo` WHERE ( `sender_city` = 'Dhaka' OR `sender_city` = 'Khulna') AND ( `receiver_city` = 'Dhaka' OR `receiver_city` = 'Khulna' ) AND `status` = 1 ");
                        ...
                        <?php 
                                ...
                                $result = mysqli_query($connect, "SELECT * FROM `cargo` WHERE ( `sender_city` = 'Dhaka' OR `sender_city` = 'Sylhet') AND ( `receiver_city` = 'Dhaka' OR `receiver_city` = 'Sylhet' ) AND `status` = 1 ");
                        ...
                        <?php 
                                ...
                                $result = mysqli_query($connect, "SELECT * FROM `cargo` WHERE ( `sender_city` = 'Dhaka' OR `sender_city` = 'Barisal') AND ( `receiver_city` = 'Dhaka' OR `receiver_city` = 'Barisal' ) AND `status` = 1 ");
